...
OUTPUT_DIR = f'C:\\Users\\Brenda\\Downloads\\Telegram Desktop\\Maize-AI 2\\Maize-AI 2\\Backend\\MaizeAi\\RCNN\\output'
...
file_path = f'C:\\Users\\Brenda\\Downloads\\Telegram Desktop\\Maize-AI 2\\Maize-AI 2\\Backend\\MaizeAi\\RCNN\\fasterrcnn_phase1.pth'
...
def extract_roi(img, img_id, boxes, output_directory):
    roi_folder = os.path.join(output_directory, OUTPUT_DIR + '\ROI')
...
def process_images_and_predict(input_directory, output_directory=OUTPUT_DIR, detection_threshold=0.6):
    # Ensure output directory exists
    os.makedirs(output_directory, exist_ok=True)

    # Create "Count" folder in the output directory
    count_folder = os.path.join(output_directory, OUTPUT_DIR + '\Count')
    ...
    for img_name in image_files:
        ...
        bbox_path = os.path.join(output_directory, OUTPUT_DIR + '\detection')
...
input_directory = f'C:\\Users\\Brenda\\Downloads\\Telegram Desktop\\Maize-AI 2\\Maize-AI 2\\Backend\\MaizeAi\\RCNN\\input'
